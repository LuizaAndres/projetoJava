...
public class Calculadora extends JFrame implements KeyListener{
    ...
    private class trataEventosAcao implements ActionListener {
        public void actionPerformed(ActionEvent event){
            ...
            if(event.getSource() == botaoPerc) teclouPerc();
            if(event.getSource() == botaoVirgula) teclouVirgula();
            if(event.getSource() == botaoBackspace) teclouBackspace();
            if(event.getSource() == botao1) teclouNumeros("1");
            if(event.getSource() == botao2) teclouNumeros("2");
            if(event.getSource() == botao3) teclouNumeros("3");
            if(event.getSource() == botao4) teclouNumeros("4");
            if(event.getSource() == botao5) teclouNumeros("5");
            if(event.getSource() == botao6) teclouNumeros("6");
            if(event.getSource() == botao7) teclouNumeros("7");
            if(event.getSource() == botao8) teclouNumeros("8");
            if(event.getSource() == botao9) teclouNumeros("9");
            if(event.getSource() == botao0) teclouNumeros("0");
            if(event.getSource() == botaoMais) teclouMais();
            if(event.getSource() == botaoMenos) teclouMenos();
            if(event.getSource() == botaoDiv) teclouDiv();
            if(event.getSource() == botaoMultip) teclouMultip();
            if(event.getSource() == botaoTotal) teclouEnter();
        }
    }
